...
function installIntoOpenCode(providerKey, models, apiKey, paths) {
  ...
  // 📖 Always use raw API keys for endpoint installs to ensure they work in Desktop mode
  // 📖 and standalone launches where the FCM environment variables are not inherited.
